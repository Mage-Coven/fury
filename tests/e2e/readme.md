...
These tests use [`kvtool`](https://github.com/mage-coven/kvtool) to spin up a fury node configuration
...
For a full example of how this looks, see [this commit](https://github.com/Mage-Coven/fury/commit/5da48c892f0a5837141fc7de88632c7c68fff4ae)
on the [example/e2e-test-upgrade-handler](https://github.com/Mage-Coven/fury/tree/example/e2e-test-upgrade-handler) branch.
