...
import (
	...
	evmutiltestutil "github.com/mage-coven/fury/x/evmutil/testutil"
...
func (suite *EIP712TestSuite) SetupTest() {
	...
	// funds our test accounts with some ufury
	...
	testcases := []struct {
		...
		},
		{
			...
			updateTx: func(txBuilder client.TxBuilder, msgs []sdk.Msg) client.TxBuilder {
				...
				gasCoins := bk.GetBalance(suite.ctx, suite.testAddr, "ufury")
